...
def code_api():
	...
	for command_result in command_results:
		code_result = analyze_command_result(command_result, code_result, "", script_result)
...
def analyze_command_result(command_result, code_result, indent, script_result):
	...
	if command_result['command_id'] == 1:
		...
		for child_command in command_result['commands']:
			code_result += analyze_command_result(child_command, "", "  ", script_result)
	if command_result['command_id'] == 2:
		condition1 = command_result['condition1'].split(";")[0].split(" ")[0]
		code_result += indent + "for i in range(" + str(condition1) + "):\n"
		for child_command in command_result['commands']:
			analyze_command_result(child_command, code_result, "  ", script_result)
